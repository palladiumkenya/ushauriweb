...
<div class="row" id="data">
        ...
        <div class="panel panel-primary" id="main_clinician">
            ...
            <div >
                ...
                <div class="panel-body"> 
                    ...
                    <button class="add_btn btn btn-primary btn-small" id="add_btn">Add Sender</button>
                    <div class="table_div">
                    ...
                    <div class="add_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="addForm">
                            <h2 id="actionLabel">Add Sender</h2>
                            ...
                            <form class="form add_form" id="add_form">
                                ...
                                <button class="submit_add_div btn btn-success btn-small" id="submit_add_div">Add Sender</button>
                    ...
                    <div class="edit_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="editForm">
                            <h2 id="actionLabel">Edit Sender</h2>
 ...
 <?php
                                ...
                                <input type="hidden" name="sender_id" class="form-control sender_id" id="edit_sender_id" />




                                <button class="submit_edit_div btn btn-success btn-small" id="submit_edit_div">Update Sender</button>
                    ...
                    <div class="delete_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="deleteForm">
                            <h2 id="actionLabel">Delete Sender</h2>
                            ...
                            <form class="form delete_form" id="delete_form">
                                ...
                                <input type="hidden" name="sender_id" class="form-control sender_id" id="delete_sender_id" />




                                <button class="submit_delete_div btn btn-success btn-small" id="submit_delete_div">Delete Sender</button>
...
<script type="text/javascript">
  ...
  $(".loader").show();
            ...
            var get_function = "get_sender_data";
            var success_alert = "Sender added successfully ... :) ";
            ...
            $.ajax({
                type: "GET",
                async: true,
                url: "<?php echo base_url(); ?>admin/get_sender_data/" + data_id,
                dataType: "JSON",
  ...
  $(".loader").hide();
                    $.each(response, function (i, value) {
                        ...
                        $('#delete_sender_id').val(value.id);

                        var delete_descripton = "Do you want to delete Sender :  " + value.name + "";
        ...
        $(".submit_add_div").click(function () {
            var controller = "admin";
            var submit_function = "add_sender";
        ...
        $(".submit_edit_div").click(function () {
            var controller = "admin";
            var submit_function = "edit_sender";
            var form_class = "edit_form";
            var success_alert = "Sender data updated successfully ... :) ";
            var error_alert = "Ooops , Something really bad has happened (:";
            submit_data(controller, submit_function, form_class, success_alert, error_alert);
        });
        ...
        $(".submit_delete_div").click(function () {
            var controller = "admin";
            var submit_function = "delete_sender";
            var form_class = "delete_form";
            var success_alert = "Sender data delete successfully ... :) ";
            var error_alert = "Ooops , Something really bad has happened (:";
            submit_data(controller, submit_function, form_class, success_alert, error_alert);
        });
