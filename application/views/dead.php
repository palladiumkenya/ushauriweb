    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary" id="main_clinician">
            ...
            <div class="panel-heading">
                Al Clients that are marked as Deceased
            </div>
            <div >
                                        ...
                                        <div class='col-xs-5'>
                                            <section class='panel'>
                                                ...
                                                <div class='panel-body'>  <div class='form'>
                                                        ...
                                                        <select class='form-control edit_status' name='status' id='edit_status'>
                                                            <option value=''> Please select : </option>
                                                            <option value='Active'> Active </option>
                                                            <option value='Disabled'> Disabled </option>
                                                            <option value="Deased">Deceased</option>
                                                        </select>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response, function (i, value) {
                        ...
                        $('#edit_enrollment_date').val(value.enrollment_date);
                        $('#edit_art_date').val(value.art_date);
