    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary" id="main_clinician">
            ...
            <div class="panel-heading"> 
                All Client groups in the  system
            </div>   
            <div >
                ...
                <div class="panel-body"> 
                    ...
                    <button class="add_btn btn btn-primary btn-small" id="add_btn">Add Group</button>
                    <div class="table_div">
                    ...
                    <div class="add_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="addForm">
                            <h2 id="actionLabel">Add Group</h2>
                            ...
                            <form class="form add_form" id="add_form">
                                ...
                                <button class="submit_add_div btn btn-success btn-small" id="submit_add_div">Add Group</button>
                    ...
                    <div class="edit_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="editForm">
                            <h2 id="actionLabel">Edit Group</h2>
                            ...
                            <form class="form edit_form" id="edit_form">
                                ...
                                <input type="hidden" name="group_id" class="form-control group_id" id="edit_group_id" />




                                <button class="submit_edit_div btn btn-success btn-small" id="submit_edit_div">Update Group</button>
                    ...
                    <div class="delete_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="deleteForm">
                            <h2 id="actionLabel">Delete Group</h2>
                            ...
                            <form class="form delete_form" id="delete_form">
                                ...
                                <input type="hidden" name="group_id" class="form-control group_id" id="delete_group_id" />




                                <button class="submit_delete_div btn btn-success btn-small" id="submit_delete_div">Delete Group</button>
