...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        if ($access_level == 'Admin' or $access_level == 'Donor' or $access_level == 'National') {
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/NationalGeographicalMapDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
...
WHERE
	tbl_partner_facility.partner_id = $partner_id GROUP BY tbl_county.id";
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/PartnerGeographicalMapDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
...
WHERE
	...
	tbl_sub_county.id ";
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/CountyGeographicalMapDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
...
WHERE
	...
	tbl_master_facility.code ";
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/SubCountyGeographicalMapDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
        } elseif ($access_level == 'Facility') {
            $facility = str_replace('\' ', '\'', ucwords(str_replace('\'', '\' ', strtolower($this->session->userdata('facility_name')))));

            $view = "views/T4AUshauri-LATESTAUG28THUPDATEGEOGRAPHICALDASHBOARD/GeographicalMapLatestNational?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&Facility=$facility"; // View URL 
        } else {
