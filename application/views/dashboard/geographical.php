    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>"> Geographical Dahsboard</a></li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
...
WHERE
	...
	tbl_master_facility.code ";
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
                $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232_0/FacilityGeographicalMapDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$facility"; // View URL 
            } else {
                //Live Link
                $view = "/views/Ushauri-GEOGRAPHICALDASHBOARD/FacilityGeographicalMap?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$facility"; // View URL 
            }
        } else {
