    ...
    <div class="container-fluid">
        ...
        if ($access_level == 'Admin' or $access_level == 'Donor' or $access_level == 'National') {
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
                $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/REPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";
            } else {
                //Live Link
                $view = "/views/Ushauri-GEOGRAPHICALDASHBOARD/REPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
            }
...
WHERE
	tbl_partner_facility.partner_id = $partner_id GROUP BY tbl_county.id";
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
                $view = "https://tableau.mhealthkenya.co.ke/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/PARTNERREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&$embeded_url";
                 } else {
                //Live Link
                $view = "/views/Ushauri-GEOGRAPHICALDASHBOARD/PARTNERREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&$embeded_url"; // View URL 
            }
...
WHERE
	...
	tbl_sub_county.id ";
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
                $view = "https://tableau.mhealthkenya.co.ke/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/COUNTYREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&$embeded_url";
                 } else {
                //Live Link
                $view = "/views/Ushauri-GEOGRAPHICALDASHBOARD/COUNTYREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
            }
...
WHERE
	...
	tbl_master_facility.code ";
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
                $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/SUBCOUNTYREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&$embeded_url";
                 } else {
                //Live Link
                $view = "/views/Ushauri-GEOGRAPHICALDASHBOARD/SUBCOUNTYREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
            }
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
                $view = "/views/Ushauri-GEOGRAPHICALDASHBOARD/FACILITYREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&Facility=$facility"; // View URL 
            } else {
                //Live Link
                $view = "/views/Ushauri-GEOGRAPHICALDASHBOARD/FACILITYREPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&Facility=$facility"; // View URL 
            }
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link
                $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/REPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
            } else {
                //Live Link
                $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/REPORTOFMESSAGESOVERTIME?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
            }
