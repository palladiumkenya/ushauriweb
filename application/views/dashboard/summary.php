...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
             <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>"> Summary Report </a></li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
    ...
    <div class="container-fluid">
        ...
        if ($access_level == 'Admin' or $access_level == 'Donor' or $access_level == 'National') {
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/GeographicalMapLatestUpdate?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
            ...
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
                $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/PartnerGeographicalMapDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url";
            } else {
                //Live Link
                $view = "/views/T4AUSHAURI-AppointmentsDashboard/NationalAppointmentsUpdatedDashboardFacility?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
            }
...
WHERE
	...
	tbl_sub_county.id ";
            ...
            $view = "views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/COUNTYSUMMARYREPORT?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
...
WHERE
	...
	tbl_master_facility.code ";
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/SUBCOUNTYSUMMARYREPORT?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/FACILITYSUMMARYREPORT?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=noFacility=$facility"; // View URL 
        } else {
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
            } else {
            ...
            $view = "/views/T4AUshauri-GEOGRAPHICALDASHBOARDUPDATED1232/CLIENTSUMMARYREPORT?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
        }
