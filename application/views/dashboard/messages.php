...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
             <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>"> Messages Dashboard</a></li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
    ...
    <div class="container-fluid">
        ...
        if ($access_level == 'Admin' or $access_level == 'Donor' or $access_level == 'National') {
            ...
            $view = "/views/T4AUSHAURI-AppointmentsDashboard_0/MessagesSentDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
...
WHERE
	tbl_partner_facility.partner_id = $partner_id GROUP BY tbl_county.id";
            ...
            $view = "/views/T4AUSHAURI-AppointmentsDashboard/MessagesSentDashboardPartner?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
...
WHERE
	...
	tbl_sub_county.id ";
            ...
            $view = "/views/T4AUSHAURI-AppointmentsDashboard/MessagesSentDashboardCounty?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
...
WHERE
	...
	tbl_master_facility.code ";
            ...
            $view = "/views/T4AUSHAURI-AppointmentsDashboard/MessagesSentDashboardSubCounty?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no$embeded_url"; // View URL 
            ...
            $view = "/views/T4AUSHAURI-AppointmentsDashboard/MessagesSentDashboardFacility?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no&Facility=$facility"; // View URL 
        } else {
            if ($server_url === 'https://ushauritest.mhealthkenya.co.ke/') {
                //Test Link 
            } else {
            ...
            $view = "/views/T4AUSHAURI-AppointmentsDashboard/MessagesSentDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no"; // View URL 
        }
