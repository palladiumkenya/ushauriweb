...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>">Appointment Reports </a></li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
  ...
  <input type="hidden" name="report_name" class="report_name input-rounded input-sm form-control " id="report_name" value="Appointments Export Report"/>
                            ...
                            <tbody>
                                ...
                                foreach ($appointments as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $value->app_status; ?></td>
