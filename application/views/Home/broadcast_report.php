    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>">Broadcast Report</a></li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Broadcast Report</h4>
                        <h6 class="card-subtitle"> List of broadcasted SMS </h6>
                        <div class="table-responsive m-t-40">
                                ...
                                <div class="table_div">
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $i = 1;
                                            foreach ($user_broadcasts as $value) {
                                            ?>
                                                <tr>
                                                    <td class="a-center"><?php echo $i; ?></td>
                                                    <td><?php echo $value->name; ?></td>
                            ...
                            <div class="edit_broadcast" id="edit_broadcast" style="display: none;">
                                ...
                                <form class="update_form" id="update_form">
                                    ...
                                    <span colspan='2' align='left'>
                                        <h2 style='color:Black;'>Clients Broadcast Service </h2>
                                    </span>
                                    <div class='row'>
