...
<div class="row" id="data">
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary" id="main_clinician">
            ...
            <div class="panel-heading"> 
                System Languages  in the system
            </div>   
            <div >
                ...
                <div class="panel-body"> 
                    ...
                    <div class="add_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="addForm">
                            <h2 id="actionLabel">Add Language</h2>
                    ...
                    <div class="edit_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="editForm">
                            <h2 id="actionLabel">Edit Language</h2>
   ...
   <?php
                                ...
                                <input type="hidden" name="language_id" class="form-control language_id" id="edit_language_id" />
                    ...
                    <div class="delete_div" style="display: none;">
                        ...
                        <div class="panel-body  formData" id="deleteForm">
                            <h2 id="actionLabel">Delete Language</h2>
   ...
   <?php
                                ...
                                <input type="hidden" name="language_id" class="form-control language_id" id="delete_language_id" />
...
<script type="text/javascript">
 ...
 $('.loader').show();
            ...
            var get_function = "get_language_data";
            ...
            $.ajax({
                type: "GET",
                async: true,
                url: "<?php echo base_url(); ?>admin/get_language_data/" + data_id,
                dataType: "JSON",
 ...
 $('.loader').hide();
                    $.each(response, function (i, value) {
                        ...
                        $('#delete_language_id').val(value.id);

                        var delete_descripton = "Do you want to delete Language :  " + value.name + "";
        ...
        $(".submit_add_div").click(function () {
            var controller = "admin";
            var submit_function = "add_language";
        ...
        $(".submit_edit_div").click(function () {
            var controller = "admin";
            var submit_function = "edit_language";
        ...
        $(".submit_delete_div").click(function () {
            var controller = "admin";
            var submit_function = "delete_language";
