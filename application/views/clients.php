...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        $view = '/views/T4AUshauri-CLIENTPROGRESSREPORT/CLIENTSUMMARYREPORT?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no'; // View URL 
