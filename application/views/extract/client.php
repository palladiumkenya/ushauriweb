...
<?php echo $access_level ?>
        <div class="row">
            <form class="form-inline" >
                ...
                <button class="btn btn-default filter_client_extract btn-round  btn-small btn-primary  " type="button" name="filter_client_extract" id="filter_client_extract"> <i class="fa fa-filter"></i>  Filter</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive m-t-40">
                            ...
                            <div class="panel-body"> 
                                <div class="table_div">
                                    <div class="client_reports_div"></div>
                                </div>
                            </div>
