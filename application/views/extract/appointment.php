    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
           <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>"> Appointments Extract</a></li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form class="form-inline" >
                ...
                <button class="btn btn-default filter_appointment_extract btn-round  btn-small btn-primary  " type="button" name="filter_appointment_extract" id="filter_appointment_extract"> <i class="fa fa-filter"></i>  Filter</button>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Appointments Extract  List</h4>
                        <h6 class="card-subtitle">Raw Data Extract of all Client Appointments in the  system </h6>
                        <div class="table-responsive m-t-40">


                            <div class="panel-body"> 
                                <div class="table_div">
                                    <div class="appointment_reports_div"></div>
                                </div>
                            </div>
