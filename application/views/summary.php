...
(function (d, t) {
  ...
  bh.src = 'https://www.bugherd.com/sidebarv2.js?apikey=bu1gb7eiepimhgdog9r7rw';
...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        $view = 'views/T4AUshauri-GEOGRAPHICALDASHBOARD/GeographicalMapUpdated?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no'; // View URL 
